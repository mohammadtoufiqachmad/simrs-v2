...
$edit = mysqli_query($server,"SELECT * from tindakan where kd_tindakan='".$_GET["nmr"]."'");
$editDb = mysqli_fetch_assoc($edit);
	if($_POST["tdk"]){
			include_once("../library/koneksi.php");
			mysqli_query($server,"UPDATE tindakan set nm_tindakan='".$_POST["nama"]."', ket='".$_POST["ket"]."' where kd_tindakan='".$_GET["nmr"]."'");
