...
$edit = mysqli_query($server,"SELECT* from laboratorium where kd_lab='".$_GET["nmr"]."'");
$editDb = mysqli_fetch_assoc($edit);
	if($_POST["lab"]){
			include_once("../library/koneksi.php");
			mysqli_query($server,"UPDATE laboratorium set no_rm='".$_POST["tgl"]."', hasil_lab='".$_POST["hasil"]."', ket='".$_POST["ket"]."' where kd_lab='".$_GET["nmr"]."'");
