...
$editDb = mysqli_fetch_assoc($edit);
	if($_POST["pasien"]){
			include_once("../library/koneksi.php");
			mysqli_query($server,"UPDATE pasien set nm_pasien='".$_POST["nama"]."', j_kel='".$_POST["jk"]."', agama='".$_POST["agama"]."', alamat='".$_POST["alamat"]."', tgl_lhr='".$_POST["tgl"]."', usia='".$_POST["usia"]."', no_tlp='".$_POST["nomor"]."', nm_kk='".$_POST["kk"]."', hub_kel='".$_POST["hub_kel"]."' where no_pasien='".$_GET["nmr"]."'");
