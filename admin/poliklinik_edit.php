...
$edit = mysqli_query($server,"SELECT * from poliklinik where kd_poli='".$_GET["nmr"]."'");
$editDb = mysqli_fetch_assoc($edit);
	if($_POST["poli"]){
			include_once("../library/koneksi.php");
			mysqli_query($server,"UPDATE poliklinik set nm_poli='".$_POST["nama"]."', lantai='".$_POST["lnt"]."' where kd_poli='".$_GET["nmr"]."'");
