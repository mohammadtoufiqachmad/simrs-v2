...
$edit = mysqli_query($server,"SELECT * from dokter where kd_dokter='".$_GET["nmr"]."'");
$editDb = mysqli_fetch_assoc($edit);
	if($_POST["dkt"]){
			include_once("../library/koneksi.php");
			mysqli_query($server,"UPDATE dokter SET kd_poli='".$_POST["pol"]."', tgl_kunjungan='".$_POST["tgl"]."', kd_user='".$_POST["user"]."', nm_dokter='".$_POST["nama"]."', sip='".$_POST["sip"]."', no_tlp='".$_POST["no"]."', alamat='".$_POST["alt"]."' where kd_dokter='".$_GET["nmr"]."'");
